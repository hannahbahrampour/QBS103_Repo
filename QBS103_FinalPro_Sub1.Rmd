...
# assign this selected gene data to a variable
...
ggplot(data_merged, aes(x = "ABCA7", y = age)) +
  geom_point(color = "magenta") + # adding points and magenta color
  geom_rug() + # adding rug
  labs(title = "Scatterplot of ABCA7 Gene Expression vs Age",
       x = "Gene Expression", y = "Age") + # label the scatterplot
