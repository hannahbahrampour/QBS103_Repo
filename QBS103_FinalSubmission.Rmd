...
# the code in this chunk is very similar to the code from previous submissions
...
numeric_data <- data_merged[sapply(data_merged, is.numeric)]

variance <- apply(numeric_data, MARGIN = 1, FUN = var)

var_data <- numeric_data[order(variance, decreasing = TRUE), ]

log2_var_data <- log2(var_data)

pheatmap(log2_var_data[1:20,],
         cluster_rows = FALSE,
         cluster_cols = FALSE)
